...
if (-not $WindowsSdkBin) { throw 'Install Windows SDK 10.0.19041.0 or newer, including MakeAppx.' }
...
try {
    ...
    & (Join-Path $PSScriptRoot 'Test-StorePackage.ps1') -PackagePath (Join-Path $workDirectory $packageName) -Version $Version
