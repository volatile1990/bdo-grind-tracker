...
public sealed partial class TrackerSessionServiceTests
{
    ...
    public async Task SuccessiveSessionsKeepTheirOwnBuffCountsAndBookedPricesAfterHistoryCorrections()
    {
        ...
        Assert.Single(first.Consumptions, item => item.IsSessionStart);
        ...
        reading = HistoryBuffReading((immortal, 500), (meal, 300));
        await ProcessBuffFrame(fixture, monitor, now.AddSeconds(-12));
        reading = HistoryBuffReading((immortal, 499), (meal, 299));
        ...
        reading = HistoryBuffReading((immortal, 498), (meal, 7200));
        ...
        Assert.Equal(2, second.Consumptions.Count(item => item.IsSessionStart));
    ...
    public async Task RestoredConsumptionWithMissingPriceRemainsUnpricedWhenCurrentMarketPriceBecomesAvailable()
    {
        ...
        reading = HistoryBuffReading((meal, 599));
